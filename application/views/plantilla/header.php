        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="" >
              <i class="material-icons">cloud_download</i> Nosotros
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="" data-placement="bottom" href="" target="_blank" data-original-title="¿A&uacute;n no te has registrado?">
              Registro
            </a>
          </li>
        </ul>
